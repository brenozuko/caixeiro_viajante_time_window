...
end_time = time.time()
pm.save(
    mps="../dados/results/inst_20/inst_20.mps",
    sol="../dados/results/inst_20/inst_20.sol",
    clp="../dados/results/inst_20/inst_20.clp",
    glp="../dados/results/inst_20/inst_20.glp",
    sen="../dados/results/inst_20/inst_20.sen",
    ipt="../dados/results/inst_20/inst_20.ipt",
    mip="../dados/results/inst_20/inst_20.mip",
)
...
plt.savefig("../dados/results/inst_20/inst_20_result.png")
plt.show(block=True)
