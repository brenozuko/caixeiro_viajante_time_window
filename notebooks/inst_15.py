...
end_time = time.time()
pm.save(
    mps="../dados/results/inst_15/inst_15.mps",
    sol="../dados/results/inst_15/inst_15.sol",
    clp="../dados/results/inst_15/inst_15.clp",
    glp="../dados/results/inst_15/inst_15.glp",
    sen="../dados/results/inst_15/inst_15.sen",
    ipt="../dados/results/inst_15/inst_15.ipt",
    mip="../dados/results/inst_15/inst_15.mip",
)
...
plt.savefig("../dados/results/inst_15/inst_15_result.png")
plt.show(block=True)
