...
end_time = time.time()
pm.save(
    mps="../dados/results/inst_10/inst_10.mps",
    sol="../dados/results/inst_10/inst_10.sol",
    clp="../dados/results/inst_10/inst_10.clp",
    glp="../dados/results/inst_10/inst_10.glp",
    sen="../dados/results/inst_10/inst_10.sen",
    ipt="../dados/results/inst_10/inst_10.ipt",
    mip="../dados/results/inst_10/inst_10.mip",
)
...
plt.savefig("../dados/results/inst_10/inst_10_result.png")
plt.show(block=True)
